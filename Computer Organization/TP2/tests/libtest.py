...
corridas = [
    {'filtro': 'Max', 'tolerancia': 1, 'params': ''},
    {'filtro': 'Max2', 'tolerancia': 1, 'params': ''},
    {'filtro': 'Gamma', 'tolerancia': 3, 'params': ''},
    {'filtro': 'Broken', 'tolerancia': 1, 'params': ''},
    {'filtro': 'Funny', 'tolerancia': 5, 'params': ''},
]
